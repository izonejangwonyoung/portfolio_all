            ...
            <Container>
                <Row>
                    ...
                    <Col lg="3" md="6" className="m-b-30">
                        ...
                        <p>Office :  <a href="mailto:fromis9love@icloud.com" className="link">fromis9love@icloud.com</a></p>
                    </Col>
                    <Col lg="3" md="6">
                        ...
                        <div className="round-social light">
                            ...
                            <a href="https://www.instagram.com/lxftxng_woo/" className="link"><i className="fa fa-instagram"></i></a>
                        </div>
                    </Col>
                </Row>
