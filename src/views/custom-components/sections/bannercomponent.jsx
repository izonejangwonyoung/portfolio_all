                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col md="8" className="align-self-center text-center">
                            <h1 className="title"  style={{width:'700px'}}>I’m Eric shim, a novice <b className="font-bold">back-end Developer</b>, in Hongik univ. <br></br>I'm interested in <b className="font-bold">Infosec</b> and <b className="font-bold">backend development</b>. <span className="text-success-gradiant font-bold typewrite" data-period="2000" data-type='[ "Photoshop", "Web Application", "Web Designing", "Web Development" ]'></span></h1>
                            <a className="btn btn-success-gradiant btn-md btn-arrow m-t-20" data-toggle="collapse" href="https://github.com/izonejangwonyoung"><span>Checkout My Github
